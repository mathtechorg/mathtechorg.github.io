...
Based on feedback from our last workshop, our next workshop will start out using the new [PreTeXt.plus](https://pretext.plus) online editor so we can dive into the structure of PreTeXt documents right away.  We will then describe how to transition to a full PreTeXt setup for more complex documents using either a local install or Github Codespaces.
...
<!--Complete this [registration form](https://scholarlattice.org/collections/d73acd8b-b7ef-4158-90c1-9eb5365c04be/registrations/new).-->
